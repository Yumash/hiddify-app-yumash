...
// GetContext returns the context (implements ServiceInterface for CommandServer)
func (s *BoxService) GetContext() context.Context {
	return s.ctx
}

// GetClashServer returns the ClashServer (implements ServiceInterface for CommandServer)
func (s *BoxService) GetClashServer() adapter.ClashServer {
	return s.clashServer
}

// GetInstance returns the underlying Box instance (implements ServiceInterface for CommandServer)
