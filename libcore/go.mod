...
// sing-box embedded locally (forked from hiddify-sing-box v1.8.9)
replace github.com/sagernet/sing-box => ./sing-box

replace github.com/xtls/xray-core => github.com/hiddify/xray-core v0.0.0-20240902024714-0fcb0895bb4b

// wireguard-go: using sagernet's version for sing-box 1.12 compatibility
...
// ray2sing embedded locally
replace github.com/hiddify/ray2sing => ./ray2sing

// Extension system disabled
// replace github.com/hiddify/hiddify-ip-scanner-extension => ./extension/hiddify-ip-scanner-extension
